...
//     static float Kp1 = T / (3.1f * Tu * K), Ki1 = 1 / (3.1f * Tu * K); //3.1
//     static float K1s = 1, T1s = 2 * Tu;

//     static float Kp2 = 1 / (2.65f * (T1s) * K1s); //2.65
//     static float K2s = 1, T2s = 2 * T1s; //Kp1 * K1s / (1 + Kp1 * K1s)    2 * T1s / (1 + Kp2 * K1s)
                               
//     static float Kp3 = 1 / (3.65f * (T2s) * K2s * i * g); //3.4
//     static float K3s =  1, T3s = 2 * T2s; //i * g * Kp2 * K2s / (1 + Kp2 * K2s)     2 * T2s / (1 + Kp3 * K2s)

//     static float Kp4 = 1 / (3.15f * (T3s) * K3s); //1.6
